 ...
 * android相机帮助类
 */
public class CameraHelper implements RtpListener {
    private String TAG;
     ...
     */
    public CameraHelper(Activity activity, final SurfaceView surfaceView, int mCameraId, TextView tv_content) {
...
//            mediaFormat.setInteger(MediaFormat.KEY_LEVEL, MediaCodecInfo.CodecProfileLevel.AVCLevel41);
    ...
    private synchronized void destroyCamera() {
        ...
        try {
            ...
            if (rtpUtils != null) {
                rtpUtils.finiHandle(mRtpHandle);
                rtpUtils = null;
                mRtpHandle = 0;
            }
